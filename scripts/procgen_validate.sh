...
#SBATCH --output=/opt/aar/eval-user/procgenval_%j.out
...
set -euo pipefail
echo "[procgenval] $(date)"
${PY} /opt/aar/eval-user/procgen_validate.py
echo "[procgenval] DONE-WRAPPER"
